		...
		<>
		  ...
		  */}
			<div>
				...
				<div className="lg:flex lg:flex-col lg:h-screen lg:pl-72 lg:bg-red-100">
					<div className="w-full sticky top-0 z-40 lg:mx-auto lg:max-w-7xl lg:px-8">
						<div className="flex h-16 items-center gap-x-4 border-b border-gray-200 bg-white 
						px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-0 lg:shadow-none">
					...
					<main className="relative grow bg-yellow-100">
						<div className="absolute inset-0 bg-indigo-200">{children}</div>
					</main>
				</div>
			</div>
		</>
